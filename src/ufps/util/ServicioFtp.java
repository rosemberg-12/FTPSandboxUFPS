...
public class ServicioFtp {
    ...
    public boolean subirArchivo(String localFile, String hostFile){
        ...
        try{
            ...
            System.out.println("El dir es: "+file.toString());
            rs =(server.storeFile(server.printWorkingDirectory()+"/"+hostFile, fileIn));
            System.out.println(server.printWorkingDirectory()+"/"+hostFile);
            fileIn.close();
     ...
     * @return un 
     */
    public ListaCD<String> listarConTipo(){
               
        ListaCD<String> archivos=new ListaCD<String>();
        ...
        try {
            ...
            if(server.isConnected()) { 
                ...
                for(FTPFile file: archivo){
                    ...
                    if(file.isDirectory())
                        archivos.addFin(file.getName()+";"+file.getRawListing()+";directorio");
                    else archivos.addFin(file.getName()+";"+file.getRawListing()+";archivo");
